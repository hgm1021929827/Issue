...
這是一個**個人工作追蹤 Web 系統**。第一～十五階段核心功能已有應用程式碼；第二階段粉彩視覺已結束（規格仍為後續 UI 依據）。第十四、十五階段前端手動清單待使用者勾選。第十七階段工作項次待辦已結束（測試完成）。舊 Excel 設計原稿在第四階段歷史資料，不得直接實作。新畫面對齊第二階段視覺規格。
...
第一個功能從「第一階段」開始編號，資料夾加兩位數前綴（`01-`、`02-`…）；新一輪改善建立下一階段，不覆寫已結束階段的正式文件。第十二階段目錄為 `12-第十二階段－專案工作項次與工時/`。第十三階段目錄為 `13-第十三階段－正式議題 Excel 匯入/`。第十四階段目錄為 `14-第十四階段－議題列表小分類篩選/`。第十五階段目錄為 `15-第十五階段－議題列表廠商與搜尋/`。第十六階段目錄為 `16-第十六階段－正式議題工時紀錄/`。第十七階段目錄為 `17-第十七階段－工作項次待辦/`。
