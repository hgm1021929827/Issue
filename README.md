...
個人工作追蹤 Web 系統。第一、三～十五階段（分類、正式議題、多層 TODO、首頁清單與行事曆、專案與專案議題、成員與廠商、需要追蹤的 TODO、追蹤提醒與行事曆、專案頁分頁、專案議題左右切分、專案議題不顯示客戶名稱、正式議題獨立列表頁、首頁清單分頁、專案工作項次與工時、正式議題 Excel 匯入、議題列表小分類篩選、議題列表廠商與搜尋）已實作。第十六階段「正式議題工時紀錄」已實作。第十七階段「工作項次待辦」已實作。
